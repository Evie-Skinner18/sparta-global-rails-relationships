...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { cheese_id: @preference.cheese_id, cheeses: @preference.cheeses, no_cheeses: @preference.no_cheeses, tasty: @preference.tasty, user: @preference.user, user_id: @preference.user_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { cheese_id: @preference.cheese_id, cheeses: @preference.cheeses, no_cheeses: @preference.no_cheeses, tasty: @preference.tasty, user: @preference.user, user_id: @preference.user_id } }
